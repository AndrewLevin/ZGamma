...
muon_total_sieie_for_fake_photon_fraction_file = ROOT.TFile.Open("/afs/cern.ch/work/a/amlevin/data/zg/double_muon_fake_photon.root") 
muon_fake_photon_template_file = ROOT.TFile.Open("/afs/cern.ch/work/a/amlevin/data/zg/double_muon_fake_photon_template.root")
electron_total_sieie_for_fake_photon_fraction_file = ROOT.TFile.Open("/afs/cern.ch/work/a/amlevin/data/zg/double_electron_fake_photon.root") 
electron_fake_photon_template_file = ROOT.TFile.Open("/afs/cern.ch/work/a/amlevin/data/zg/double_electron_fake_photon_template.root")
real_photon_template_file = ROOT.TFile.Open("/afs/cern.ch/work/a/amlevin/data/zg/real_photon_template.root")

...
muon_fake_photon_file = ROOT.TFile.Open("/afs/cern.ch/work/a/amlevin/data/zg/2017/double_muon_fake_photon.root") 
electron_fake_photon_file = ROOT.TFile.Open("/afs/cern.ch/work/a/amlevin/data/zg/2017/double_eg_fake_photon.root") 
real_photon_template_file = ROOT.TFile.Open("/afs/cern.ch/work/a/amlevin/data/zg/2017/real_photon_template.root")
...
for lepton_name in lepton_names:
    ...
    for i in range(len(photon1_eta_ranges)):
        for j in range(len(photon1_pt_range_cutstrings)):
            ...
            #if eta_range != "abs(photon_eta) < 1.4442" or photon_pt_range_cutstring != "photon_pt > 25 && photon_pt < 30" or lepton_name != "muon":
            #    continue
...
#                sieie_cut = 0.03001
            ...
            fake_photon_tree.Draw("photon1_sieie >> total_sieie_for_fake_photon_fraction_hist",photon1_eta_range+" && (photon1_selection == 1 || photon1_selection == 2) && "+photon1_pt_range_cutstring + " && pass_selection1")
            
            fake_photon_template_hist = ROOT.TH1F("fake_photon_template_hist","fake_photon_template_hist",n_bins,sieie_lower,sieie_upper)
            fake_photon_tree.Draw("photon2_sieie >> fake_photon_template_hist",photon2_eta_range + " && lepton_pdg_id == "+lepton_pdg_id+" && "+photon2_pt_range_cutstring + " && pass_selection2")
            ...
            c1.SaveAs("/eos/user/a/amlevin/www/zg/2017/fake-photon/"+lepton_name+"/"+eta_range_no_spaces+"/real_photon_template_"+photon_pt_range_cutstring_no_spaces+".png")
            ...
            c1.SaveAs("/eos/user/a/amlevin/www/zg/2017/fake-photon/"+lepton_name+"/"+eta_range_no_spaces+"/fake_photon_template_"+photon_pt_range_cutstring_no_spaces+".png")
            ...
            c1.SaveAs("/eos/user/a/amlevin/www/zg/2017/fake-photon/"+lepton_name+"/"+eta_range_no_spaces+"/total_"+photon_pt_range_cutstring_no_spaces+".png")

            total_hist.Draw("Ep")

            ffitter.GetPlot().Draw("same")

            c1.SaveAs("/eos/user/a/amlevin/www/zg/2017/fake-photon/"+lepton_name+"/"+eta_range_no_spaces+"/fit_"+photon_pt_range_cutstring_no_spaces+".png")
...
#            print total_sieie_for_fake_photon_fraction_tree.GetEntries(eta_range+" && lepton_pdg_id == "+lepton_pdg_id+" && (photon_selection == 0 || photon_selection == 1) && "+ photon_pt_range_cutstring)
            ...
            print value*fake_photon_template_hist.Integral(1,fake_photon_template_hist.GetXaxis().FindFixBin( sieie_cut )-1)*total_hist.Integral()/total_hist.Integral(1,total_hist.GetXaxis().FindFixBin( sieie_cut )-1)/fake_photon_template_hist.Integral()


            array_fitted_fraction = np.array([value,error])

            array_fake_fraction = array_fitted_fraction * fake_photon_template_hist.Integral(1,fake_photon_template_hist.GetXaxis().FindFixBin( sieie_cut )-1)*total_hist.Integral()/total_hist.Integral(1,total_hist.GetXaxis().FindFixBin( sieie_cut )-1)/fake_photon_template_hist.Integral()
            array_fake_event_weight = array_fitted_fraction * fake_photon_template_hist.Integral(1,fake_photon_template_hist.GetXaxis().FindFixBin( sieie_cut )-1)*total_hist.Integral()/fake_photon_template_hist.Integral()/fake_photon_tree.GetEntries(photon1_eta_range + " && (photon1_selection == 0 || photon1_selection == 1) && "+ photon1_pt_range_cutstring + " && pass_selection1")
